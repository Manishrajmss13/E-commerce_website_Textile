...
function getproducts(){
    global $con;
    //condition to check if set or not
...
function get_unique_sellers(){
    ...
    $num_of_rows=mysqli_num_rows($result_query);
    if($num_of_rows==0){
        echo "<h2 class='text-center text-danger'>No product available for this seller😔</h2>";
    }
...
function getsellers(){   
    ...
    $result_sellers=mysqli_query($con,$select_sellers);
   // $row_data=mysqli_fetch_assoc($result_sellers);
   // echo $row_data['seller_title'];
